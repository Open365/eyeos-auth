...
var AuthenticationExpressMiddleware = require('../lib/AuthenticationExpressMiddleware');
var EyeosAuth = require('../lib/EyeosAuth');


suite('AuthenticationExpressMiddleware', function(){
    var sut;
    ...
    setup(function(){
        ...
        sut = new AuthenticationExpressMiddleware(eyeosAuth);
    });
